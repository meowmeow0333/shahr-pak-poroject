...
"""
repositories.py
پیاده‌سازی الگوی طراحی Repository (یکی از الگوهای GoF مورد نیاز فاز ۵).
هر Repository مسئول تبدیل ردیف‌های پایگاه داده به Object های دامنه (models.py) و برعکس است.
این لایه، لایه‌ی سرویس (services.py) را از جزئیات SQL جدا می‌کند (اصل SRP از SOLID).
"""
...
class ReportRepository:
    ...
    def find_all(self, status: ReportStatus = None, keyword: str = None):
        """پشتیبانی از فیلتر بر اساس وضعیت و جستجوی متنی (FR-11)."""
